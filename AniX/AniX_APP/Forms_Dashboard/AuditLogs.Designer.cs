...
namespace AniX_APP.Forms_Dashboard
{
    partial class AuditLogs
    {
        ...
        private void InitializeComponent()
        {
            ...
            // roundPanelListBox1
            // 
            roundPanelListBox1.Controls.Add(dgvAudit);
            ...
            dgvAudit.BackgroundColor = Color.FromArgb(231, 34, 83);
            ...
            dgvAudit.GridColor = Color.FromArgb(11, 7, 17);
            dgvAudit.Location = new Point(1, 0);
            dgvAudit.Name = "dgvAudit";
            dgvAudit.ReadOnly = true;
            dgvAudit.RowHeadersWidth = 62;
            dgvAudit.RowTemplate.Height = 28;
            dgvAudit.Size = new Size(843, 272);
            dgvAudit.TabIndex = 2;
            // 
            // AuditLogs
            // 
