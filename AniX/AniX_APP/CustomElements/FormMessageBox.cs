...
namespace CustomMessageBox.Private
{
    ...
    {
        //Fields
        private Color primaryColor = Color.FromArgb(231, 34, 83);
        ...
        public Color PrimaryColor
        {
            ...
            set
            {
                ...
                this.panelTitleBar.BackColor = Color.FromArgb(11, 7, 17); ;//Title Bar Back Color
            }
        }
        ...
        private void SetButtons(MessageBoxButtons buttons, MessageBoxDefaultButton defaultButton)
        {
            ...
            switch (buttons)
            {
                ...
                case MessageBoxButtons.YesNo:
                    ...
                    button2.BackColor = Color.FromArgb(231, 34, 83);
                    button2.ForeColor = Color.FromArgb(11, 7, 17);
