...
namespace AniX_BusinessLogic
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public void SetWebUserSession(User user)
        {
            ...
            {
                string defaultProfileImageUrl = "https://i499309.luna.fhict.nl/assets/media/profile/profile.png";

                string profileImagePath = user.ProfileImagePath ?? defaultProfileImageUrl;
