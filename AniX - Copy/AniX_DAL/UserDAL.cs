    ...
    public class UserDAL : BaseDAL, IUserManagement
    {
        ...
        public async Task<bool> CreateAsync(User user)
        {
            try
            {
                ...
                command.Parameters.AddWithValue("@profileImagePath", user.ProfileImagePath ?? string.Empty);
        ...
        public async Task<bool> UpdateAsync(User user)
        {
            ...
            {
                await connection.OpenAsync();
                string query = "UPDATE [User] SET Username = @username, Password = @password, Salt = @salt, Email = @email, Banned = @banned, IsAdmin = @isAdmin, ProfileImagePath = @profileImagePath WHERE Id = @id";
                SqlCommand command = new SqlCommand(query, connection);
        ...
        public async Task<bool> UpdateAPPAsync(User user)
        {
            try
            {
                await connection.OpenAsync();
