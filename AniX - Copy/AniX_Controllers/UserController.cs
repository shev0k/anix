...
namespace AniX_Controllers
{
    public class UserController
    {
        ...
        public async Task<bool> UpdateAsync(User user)
        {
            try
            {
                return await _userManagement.UpdateAsync(user);
            }
            catch (Exception e)
            {
                await ExceptionHandlingService.HandleExceptionAsync(e);
        ...
        public async Task<User> GetUserByIdAsync(int userId)
        {
            try
            {
                return await _userManagement.GetUserFromIdAsync(userId);
            }
            catch (Exception e)
            {
                await ExceptionHandlingService.HandleExceptionAsync(e);
        ...
        {
            return "https://i499309.luna.fhict.nl/assets/media/profile/profile.png";
        }
